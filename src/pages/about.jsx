        ...
        <div className="columns">
          <div className="column is-8">
            <div className="content hv-about-content">
              ...
              <p>
                I have been working on various projects to polish my skills in
                Computer Programming, Graphic Design, Video Production,
                Photography, Leadership as well as taking part in community
                activities.
              </p>
              <p>
                I am a
                ...
                <b>good friend</b>
                . Currently a
                                high school senior, I’m on my way to explore myself.
              </p>
              <blockquote>
                <p>
                  “Sometimes life’s going to hit you in the head with a brick.
                  Don’t lose faith. I’m convinced that the only thing that kept
