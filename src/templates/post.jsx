...
const PostTemplate = ({ data }) => {
  const {
    title, content, image, description, author, publishDate, category,
              ...
              <div className="hv-post-meta">
                <div>
                  <figure className="image is-48x48 is-inline-block">
                    <a href={author[0].link} target="_blank" rel="noreferrer noopener">
                      <img className="is-rounded" src={`${author[0].image.file.url}?w=128`} alt={author[0].name} />
                    </a>
                  </figure>
                </div>
                <div className="hv-post-meta-detail">
                  <div>
                    <a href={author[0].link} className="hv-post-author" target="_blank" rel="noreferrer noopener">{author[0].name}</a>
                  </div>
                  <div>
          ...
          <div className="container">
            <div className="columns is-centered">
              <div className="column is-8">
                <div className="content" dangerouslySetInnerHTML={{ __html: content.childMarkdownRemark.html }} />
              </div>
            </div>
          </div>
        </section>
