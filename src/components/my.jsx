  ...
  <section className="section is-family-code">
    <div className="container">
      ...
      <div className="columns is-multiline">
        <Link style={{ backgroundColor: '#3F51B5' }} className="column has-text-centered hv-section-card" to="/about">
          <h3 className="title hv-animate-text-stroke">Self</h3>
          <img src={mathematicsSvg} alt="About me" />
        </Link>
        <Link style={{ backgroundColor: '#673AB7' }} className="column has-text-centered hv-section-card" to="/portfolio">
          <h3 className="title hv-animate-text-stroke">Portfolio</h3>
          <img src={startupLifeSvg} alt="Portfolio" />
        </Link>
        <Link style={{ backgroundColor: '#009688' }} className="column has-text-centered hv-section-card" to="/blog">
